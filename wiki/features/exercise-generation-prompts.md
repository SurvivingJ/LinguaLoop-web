...
open_questions:
  ...
  - "Chinese L1 listening exercises reach the renderer, but no TTS pipeline exists for Chinese yet — pinyin is generated by P1 but not yet rendered to audio. L1 cannot actually play audio to the learner until the TTS pipeline ships."
